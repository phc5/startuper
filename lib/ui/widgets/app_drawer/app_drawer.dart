...
import 'package:ideabuilder/ui/widgets/app_drawer/app_drawer_desktop.dart';
...
class AppDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ScreenTypeLayout(
      ...
      tablet: AppDrawerTabletPortrait(),
  ...
  static List<Widget> getDrawerOptions() {
    return [
      DrawerOption(
          title: 'Home', iconData: Icons.home, route: Routes.homeViewRoute),
      DrawerOption(
        title: 'Reports',
