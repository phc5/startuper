...
import 'package:ideabuilder/ui/views/settings/settings_view_desktop.dart';
import 'package:ideabuilder/ui/views/settings/settings_view_mobile.dart';
import 'package:ideabuilder/ui/views/settings/settings_view_tablet.dart';
      ...
      builder: (context, screenSizeInformation) {
        return ViewModelBuilder<SettingsViewModel>.reactive(
          ...
          builder: (context, model, child) => ScreenTypeLayout(
            mobile: SettingsMobilePortrait(model),
            tablet: SettingsTablet(model),
            desktop: SettingsDesktop(model),
          ),
        );
      },
    );
